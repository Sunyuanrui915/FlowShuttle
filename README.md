...
当前版本为 `v0.3.1`。流梭仍处于早期公开阶段，欢迎下载体验并反馈问题。
...
The current version is `v0.3.1`. Flow Shuttle is still an early public release. It is local-first by default, does not require login, and does not upload your work content by itself.
